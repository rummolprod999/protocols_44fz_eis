...
class ProtocolEZT2020Final(Protocol504, Participiant504):
    add = 0
    update = 0
...
def parserEZT2020Final(doc, path_xml, filexml, reg, type_f):
    p = ProtocolEZT2020Final(doc, filexml)
    ...
    if updated:
        ProtocolEZT2020Final.update_ += 1
    else:
        ProtocolEZT2020Final.add += 1
