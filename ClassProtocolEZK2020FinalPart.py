...
class ProtocolEZK2020FinalPart(Protocol504, Participiant504):
    add_protocolEZK2020FinalPart = 0
    update_protocolEZK2020FinalPart = 0
...
def parserEZK2020FinalPart(doc, path_xml, filexml, reg, type_f):
    p = ProtocolEZK2020FinalPart(doc, filexml)
    ...
    if updated:
        ProtocolEZK2020FinalPart.update_protocolEZK2020FinalPart += 1
    else:
        ProtocolEZK2020FinalPart.add_protocolEZK2020FinalPart += 1
