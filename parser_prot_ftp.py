...
if __name__ == "__main__":
    ...
    logging_parser('Добавлено EOK1, EOKD1', ClassProtocolEOK1.ProtocolEOK1.add_protocolEOK1)
    logging_parser('Обновлено EOK1, EOKD1', ClassProtocolEOK1.ProtocolEOK1.update_protocolEOK1)
