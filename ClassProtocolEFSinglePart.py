...
class ProtocolEFSinglePart(Protocol, Participiant):
    add_protocolEFSinglePart = 0
    update_protocolEFSinglePart = 0
...
def parserEFSinglePart(doc, path_xml, filexml, reg, type_f):
    p = ProtocolEFSinglePart(doc, filexml)
    ...
    if updated:
        ProtocolEFSinglePart.update_protocolEFSinglePart += 1
    else:
        ProtocolEFSinglePart.add_protocolEFSinglePart += 1
