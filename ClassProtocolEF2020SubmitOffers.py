...
def parserEF2020SubmitOffers(doc, path_xml, filexml, reg, type_f):
    p = ProtocolEF2020SubmitOffers(doc, filexml)
    ...
    if updated:
        ProtocolEF2020SubmitOffers.update += 1
    else:
        ProtocolEF2020SubmitOffers.add += 1
