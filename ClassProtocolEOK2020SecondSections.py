...
class ProtocolEOK2020SecondSections(ProtocolEOK2):
    add = 0
    update = 0
...
def parserEOK2020SecondSections(doc, path_xml, filexml, reg, type_f):
    p = ProtocolEOK2020SecondSections(doc, filexml)
    ...
    if updated:
        ProtocolEOK2020SecondSections.update += 1
    else:
        ProtocolEOK2020SecondSections.add += 1
